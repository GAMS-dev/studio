...
EnvVarConfigEditor::EnvVarConfigEditor(const QList<EnvVarConfigItem *> &initParams, QWidget *parent):
    QWidget(parent),
...
void EnvVarConfigEditor::init(const QList<EnvVarConfigItem *> &initParams)
{
