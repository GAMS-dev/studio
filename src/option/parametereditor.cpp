...
{
    QAction* insertParameterAction = mContextMenu.addAction(QIcon(":/img/insert"), "Insert new parameter", [this]() { insertParameter(); });
    ...
    QAction* deleteAction = mContextMenu.addAction(QIcon(":/img/delete-all"), "Delete selection", [this]() { deleteParameter(); });
    ...
    QAction* deleteAllAction = mContextMenu.addAction(QIcon(":/img/delete-all"), "Delete all parameters", [this]() { deleteAllParameters(); });
    ...
    QAction* moveUpAction = mContextMenu.addAction(QIcon(":/img/move-up"), "Move up", [this]() { moveParameterUp(); });
    ...
    QAction* moveDownAction = mContextMenu.addAction(QIcon(":/img/move-down"), "Move down", [this]() { moveParameterDown(); });
