...
int GamsParamTableModel::rowCount(const QModelIndex &parent) const
{
    if (parent.isValid())
        return 0;
...
int GamsParamTableModel::columnCount(const QModelIndex &parent) const
{
    if (parent.isValid())
        return 0;
    return mHeader.size();
...
QVariant GamsParamTableModel::data(const QModelIndex &index, int role) const
{
...
bool GamsParamTableModel::setHeaderData(int index, Qt::Orientation orientation, const QVariant &value, int role)
{
...
bool GamsParamTableModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
    if (role == Qt::EditRole)   {
...
QModelIndex GamsParamTableModel::index(int row, int column, const QModelIndex &parent) const
{
...
bool GamsParamTableModel::insertRows(int row, int count, const QModelIndex &parent)
{
    Q_UNUSED(parent)
...
bool GamsParamTableModel::removeRows(int row, int count, const QModelIndex &parent)
{
    Q_UNUSED(parent)
...
bool GamsParamTableModel::moveRows(const QModelIndex &sourceParent, int sourceRow, int count, const QModelIndex &destinationParent, int destinationChild)
{
...
QStringList GamsParamTableModel::mimeTypes() const
{
    QStringList types;
...
QMimeData *GamsParamTableModel::mimeData(const QModelIndexList &indexes) const
{
...
Qt::DropActions GamsParamTableModel::supportedDragActions() const
{
    return Qt::MoveAction ;
}

Qt::DropActions GamsParamTableModel::supportedDropActions() const
{
    return Qt::MoveAction | Qt::CopyAction ;
}

bool GamsParamTableModel::dropMimeData(const QMimeData* mimedata, Qt::DropAction action, int row, int column, const QModelIndex &parent)
{
    Q_UNUSED(column)
...
QString GamsParamTableModel::getParameterTableEntry(int row)
{
...
void GamsParamTableModel::setRowCount(int rows)
{
...
void GamsParamTableModel::itemizeOptionFromCommandLineStr(const QString &text)
{
