...
ConfigTableModel::ConfigTableModel(const QList<ParamConfigItem *> &itemList, OptionTokenizer *tokenizer, QObject *parent):
...
QVariant ConfigTableModel::headerData(int index, Qt::Orientation orientation, int role) const
{
...
bool ConfigTableModel::setHeaderData(int index, Qt::Orientation orientation, const QVariant &value, int role)
{
...
bool ConfigTableModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
...
QModelIndex ConfigTableModel::index(int row, int column, const QModelIndex &parent) const
{
...
bool ConfigTableModel::insertRows(int row, int count, const QModelIndex &parent)
{
    Q_UNUSED(parent)
...
bool ConfigTableModel::removeRows(int row, int count, const QModelIndex &parent)
{
    Q_UNUSED(parent)
...
bool ConfigTableModel::moveRows(const QModelIndex &sourceParent, int sourceRow, int count, const QModelIndex &destinationParent, int destinationChild)
{
...
QStringList ConfigTableModel::mimeTypes() const
{
    QStringList types;
...
QMimeData *ConfigTableModel::mimeData(const QModelIndexList &indexes) const
{
...
Qt::DropActions ConfigTableModel::supportedDragActions() const
{
    return Qt::MoveAction ;
}

Qt::DropActions ConfigTableModel::supportedDropActions() const
{
    return Qt::MoveAction | Qt::CopyAction ;
}

bool ConfigTableModel::dropMimeData(const QMimeData *mimedata, Qt::DropAction action, int row, int column, const QModelIndex &parent)
{
    Q_UNUSED(column)
...
const QList<ParamConfigItem *> ConfigTableModel::parameterConfigItems()
{
    return mOptionItem;
}
...
void ConfigTableModel::updateRecurrentStatus()
{
    QList<int> idList;
...
void ConfigTableModel::updateCheckState()
{
    for(int i = 0; i<mOptionItem.size(); ++i) {
...
void ConfigTableModel::setRowCount(int rows)
{
...
QString ConfigTableModel::getParameterTableEntry(int row)
{
