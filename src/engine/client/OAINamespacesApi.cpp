...
QString OAINamespacesApi::getParamStylePrefix(QString style){
    if(style == "matrix"){
        return ";";
    }else if(style == "label"){
        return ".";
...
QString OAINamespacesApi::getParamStyleSuffix(QString style){
    if(style == "matrix"){
        return "=";
    }else if(style == "label"){
        return "";
...
QString OAINamespacesApi::getParamStyleDelimiter(QString style, QString name, bool isExplode){
...
void OAINamespacesApi::createModel(const QString &r_namespace, const QString &model, const OAIHttpFileElement &data, const ::OpenAPI::OptionalParam<QList<QString>> &arguments, const ::OpenAPI::OptionalParam<QString> &run, const ::OpenAPI::OptionalParam<OAIHttpFileElement> &inex_file) {
...
void OAINamespacesApi::createModelDeprecated(const QString &r_namespace, const QString &model, const OAIHttpFileElement &data, const ::OpenAPI::OptionalParam<QList<QString>> &arguments, const ::OpenAPI::OptionalParam<QString> &run, const ::OpenAPI::OptionalParam<OAIHttpFileElement> &inex_file) {
...
void OAINamespacesApi::updateModel(const QString &r_namespace, const QString &model, const ::OpenAPI::OptionalParam<OAIHttpFileElement> &data, const ::OpenAPI::OptionalParam<OAIHttpFileElement> &inex_file, const ::OpenAPI::OptionalParam<QList<QString>> &arguments, const ::OpenAPI::OptionalParam<QString> &run, const ::OpenAPI::OptionalParam<bool> &delete_inex_file, const ::OpenAPI::OptionalParam<bool> &delete_arguments, const ::OpenAPI::OptionalParam<bool> &delete_run) {
    ...
    if(arguments.hasValue())
    {
        input.add_var("arguments", ::OpenAPI::toStringValue(arguments.value()));
    }
    if(run.hasValue())
    {
        input.add_var("run", ::OpenAPI::toStringValue(run.value()));
    }
    if(delete_inex_file.hasValue())
    {
        input.add_var("delete_inex_file", ::OpenAPI::toStringValue(delete_inex_file.value()));
    }
    if(delete_arguments.hasValue())
    {
        input.add_var("delete_arguments", ::OpenAPI::toStringValue(delete_arguments.value()));
    }
    if(delete_run.hasValue())
    {
        input.add_var("delete_run", ::OpenAPI::toStringValue(delete_run.value()));
    }
...
void OAINamespacesApi::updateModelDeprecated(const QString &r_namespace, const QString &model, const ::OpenAPI::OptionalParam<OAIHttpFileElement> &data, const ::OpenAPI::OptionalParam<OAIHttpFileElement> &inex_file, const ::OpenAPI::OptionalParam<QList<QString>> &arguments, const ::OpenAPI::OptionalParam<QString> &run, const ::OpenAPI::OptionalParam<bool> &delete_inex_file, const ::OpenAPI::OptionalParam<bool> &delete_arguments, const ::OpenAPI::OptionalParam<bool> &delete_run) {
