...
public:
    ...
    */
    void createInstance(const QString &label, const double &cpu_request, const qint32 &memory_request, const double &multiplier);
    ...
    */
    void getUsage(const QString &username, const ::OpenAPI::OptionalParam<bool> &recursive = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QDateTime> &from_datetime = ::OpenAPI::OptionalParam<QDateTime>(), const ::OpenAPI::OptionalParam<QDateTime> &to_datetime = ::OpenAPI::OptionalParam<QDateTime>(), const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    void updateInstance(const QString &label, const double &cpu_request, const qint32 &memory_request, const double &multiplier, const QString &old_label);
...
signals:
    ...
    void getInstancesSignal(QList<OAIModel_instance_info> summary);
    ...
    void getInstancesSignalFull(OAIHttpRequestWorker *worker, QList<OAIModel_instance_info> summary);
    ...
    void getInstancesSignalE(QList<OAIModel_instance_info> summary, QNetworkReply::NetworkError error_type, QString error_str);
