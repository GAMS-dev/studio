...
public:
    OAIJobsApi(const QString &scheme = "http", const QString &host = "localhost", int port = 0, const QString &basePath = "/api", const int timeOut = 0);
    ~OAIJobsApi();
    ...
    void createJob(const QString &model, const QString &_namespace, const QString &stdout_filename, const QList<QString> &text_entries, const QList<QString> &stream_entries, const QList<QString> &arguments, const OAIHttpFileElement &model_data, const OAIHttpFileElement &data, const OAIHttpFileElement &inex_file);
...
signals:
    ...
    void getJobZipSignalFull(OAIHttpRequestWorker *worker);
