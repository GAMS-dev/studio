...
#define FI_VERSION                 STUDIO_MAJOR_VERSION,STUDIO_MINOR_VERSION,STUDIO_PATCH_LEVEL,0
#define FI_VERSION_STR             QUOTE(STUDIO_MAJOR_VERSION.STUDIO_MINOR_VERSION.STUDIO_PATCH_LEVEL.0)
