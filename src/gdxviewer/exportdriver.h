...
public:
    ...
    ~ExportDriver();
    bool save(const QString& connectFile, const QString &output, bool applyFilters, QString eps, QString posInf, QString negInf, QString undef, QString na);
    void execute(const QString &connectFile, const QString &workingDirectory);
    void saveAndExecute(const QString &connectFile, const QString &output, const QString &workingDirectory, bool applyFilters, QString eps, QString posInf, QString negInf, QString undef, QString na);
...
private:
    ...
    QString generateInstructions(const QString &gdxFile, const QString &output, bool applyFilters, QString eps, QString posInf, QString negInf, QString undef, QString na);
    QString generateGdxReader(const QString &gdxFile);
    QString generateExcelWriter(const QString &excelFile, bool applyFilters, QString eps, QString posInf, QString negInf, QString undef, QString na);
