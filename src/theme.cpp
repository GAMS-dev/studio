...
void Theme::initDefault()
{
    ...
    mColorThemes[sNr].insert(Edit_currentLineBg,             drac_currentLine);
    ...
    mColorThemes[sNr].insert(Edit_currentWordBg,             drac_background);
    ...
    mColorThemes[sNr].insert(Edit_currentLineBg,             solarized_cyan.darker(50));
    mColorThemes[sNr].insert(Edit_errorBg,                   solarized_red);
    mColorThemes[sNr].insert(Edit_currentWordBg,             solarized_base2);
    mColorThemes[sNr].insert(Edit_findBg,                    solarized_blue);
    mColorThemes[sNr].insert(Edit_searchBg,                  solarized_violet);
    ...
    mColorThemes[sNr].insert(Edit_parenthesesValidBg,        solarized_yellow);
    mColorThemes[sNr].insert(Edit_parenthesesInvalidBg,      solarized_base01.lighter(125));
    mColorThemes[sNr].insert(Edit_parenthesesValidBgBlink,   solarized_yellow.darker(90));
    ...
    mColorThemes[sNr].insert(Edit_currentWordBg,             solarized_base02);
    mColorThemes[sNr].insert(Edit_findBg,                    solarized_yellow);
    mColorThemes[sNr].insert(Edit_searchBg,                  solarized_yellow.darker(120));
