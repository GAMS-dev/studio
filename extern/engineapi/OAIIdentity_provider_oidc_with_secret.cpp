...
QString OAIIdentity_provider_oidc_with_secret::getUid() const {
    return m_uid;
}
void OAIIdentity_provider_oidc_with_secret::setUid(const QString &uid) {
    m_uid = uid;
    m_uid_isSet = true;
}

bool OAIIdentity_provider_oidc_with_secret::is_uid_Set() const{
    return m_uid_isSet;
}

bool OAIIdentity_provider_oidc_with_secret::is_uid_Valid() const{
