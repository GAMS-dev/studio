...
QList<QString> OAIIdentity_provider_oauth2_with_secret::getTokenEndpointAuthMethodsSupported() const {
    return m_token_endpoint_auth_methods_supported;
}
void OAIIdentity_provider_oauth2_with_secret::setTokenEndpointAuthMethodsSupported(const QList<QString> &token_endpoint_auth_methods_supported) {
...
bool OAIIdentity_provider_oauth2_with_secret::is_token_endpoint_auth_methods_supported_Set() const{
    return m_token_endpoint_auth_methods_supported_isSet;
}

bool OAIIdentity_provider_oauth2_with_secret::is_token_endpoint_auth_methods_supported_Valid() const{
