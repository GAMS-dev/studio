...
public:
    ...
    */
    void updateConfiguration(const ::OpenAPI::OptionalParam<QString> &webhook_access = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &text_entries_max_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &hostname = ::OpenAPI::OptionalParam<QString>());
