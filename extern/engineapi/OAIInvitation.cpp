...
void OAIInvitation::fromJsonObject(QJsonObject json) {
    ...
    m_identity_provider_isValid = ::OpenAPI::fromJsonValue(identity_provider, json[QString("identity_provider")]);
    m_identity_provider_isSet = !json[QString("identity_provider")].isNull() && m_identity_provider_isValid;

    m_identity_provider_user_subject_isValid = ::OpenAPI::fromJsonValue(identity_provider_user_subject, json[QString("identity_provider_user_subject")]);
    ...
    m_invitable_identity_providers_isValid = ::OpenAPI::fromJsonValue(invitable_identity_providers, json[QString("invitable_identity_providers")]);
    ...
    m_inviter_name_isValid = ::OpenAPI::fromJsonValue(inviter_name, json[QString("inviter_name")]);
...
QJsonObject OAIInvitation::asJsonObject() const {
    ...
    if (m_identity_provider_isSet) {
        obj.insert(QString("identity_provider"), ::OpenAPI::toJsonValue(identity_provider));
    }
    if (m_identity_provider_user_subject_isSet) {
        obj.insert(QString("identity_provider_user_subject"), ::OpenAPI::toJsonValue(identity_provider_user_subject));
    }
    if (invitable_identity_providers.size() > 0) {
        obj.insert(QString("invitable_identity_providers"), ::OpenAPI::toJsonValue(invitable_identity_providers));
    }
    if (m_inviter_name_isSet) {
        obj.insert(QString("inviter_name"), ::OpenAPI::toJsonValue(inviter_name));
    }
...
void OAIInvitation::setIdentityProvider(const QString &identity_provider) {
    ...
    this->m_identity_provider_isSet = true;
}
...
QString OAIInvitation::getIdentityProviderUserSubject() const {
    return identity_provider_user_subject;
}
void OAIInvitation::setIdentityProviderUserSubject(const QString &identity_provider_user_subject) {
    this->identity_provider_user_subject = identity_provider_user_subject;
    this->m_identity_provider_user_subject_isSet = true;
}
...
QList<QString> OAIInvitation::getInvitableIdentityProviders() const {
    return invitable_identity_providers;
}
void OAIInvitation::setInvitableIdentityProviders(const QList<QString> &invitable_identity_providers) {
    this->invitable_identity_providers = invitable_identity_providers;
    this->m_invitable_identity_providers_isSet = true;
}
...
void OAIInvitation::setInviterName(const QString &inviter_name) {
    ...
    this->m_inviter_name_isSet = true;
}
