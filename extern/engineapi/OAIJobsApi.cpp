...
void OAIJobsApi::queryJobTextEntryCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit queryJobTextEntrySignal(output);
        emit queryJobTextEntrySignalFull(worker, output);
    } else {
        emit queryJobTextEntrySignalE(output, error_type, error_str);
        emit queryJobTextEntrySignalEFull(worker, error_type, error_str);
    }
}
...
void OAIJobsApi::queryJobTextEntryInfoCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit queryJobTextEntryInfoSignal();
        emit queryJobTextEntryInfoSignalFull(worker);
    } else {
        emit queryJobTextEntryInfoSignalE(error_type, error_str);
        emit queryJobTextEntryInfoSignalEFull(worker, error_type, error_str);
    }
}
...
void OAIJobsApi::updateJobAccessGroupsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit updateJobAccessGroupsSignal(output);
        emit updateJobAccessGroupsSignalFull(worker, output);
    } else {
        emit updateJobAccessGroupsSignalE(output, error_type, error_str);
        emit updateJobAccessGroupsSignalEFull(worker, error_type, error_str);
    }
}
...
void OAIJobsApi::updateJobTagCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit updateJobTagSignal(output);
        emit updateJobTagSignalFull(worker, output);
    } else {
        emit updateJobTagSignalE(output, error_type, error_str);
        emit updateJobTagSignalEFull(worker, error_type, error_str);
    }
}
