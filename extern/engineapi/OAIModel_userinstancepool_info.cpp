...
void OAIModel_userinstancepool_info::fromJsonObject(QJsonObject json) {
    ...
    m_instance_pools_available_isValid = ::OpenAPI::fromJsonValue(instance_pools_available, json[QString("instance_pools_available")]);
...
QJsonObject OAIModel_userinstancepool_info::asJsonObject() const {
    QJsonObject obj;
    if (instance_pools_available.size() > 0) {
        obj.insert(QString("instance_pools_available"), ::OpenAPI::toJsonValue(instance_pools_available));
    }
    return obj;
}

QList<OAIModel_instance_pool_info> OAIModel_userinstancepool_info::getInstancePoolsAvailable() const {
    return instance_pools_available;
}
void OAIModel_userinstancepool_info::setInstancePoolsAvailable(const QList<OAIModel_instance_pool_info> &instance_pools_available) {
    this->instance_pools_available = instance_pools_available;
    this->m_instance_pools_available_isSet = true;
}
