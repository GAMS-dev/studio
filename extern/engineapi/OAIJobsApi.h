...
public:
    ...
    */
    void consumeStreamEntry(const QString &token, const QString &entry_name);
    ...
    * @param[in]  length qint32 [optional]
    */
    void queryJobTextEntry(const QString &token, const QString &entry_name, const ::OpenAPI::OptionalParam<qint32> &start_position = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &length = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  token QString [required]
    * @param[in]  entry_name QString [required]
    */
    void queryJobTextEntryInfo(const QString &token, const QString &entry_name);

    /**
    * @param[in]  token QString [required]
    * @param[in]  access_groups QList<QString> [optional]
    */
    void updateJobAccessGroups(const QString &token, const ::OpenAPI::OptionalParam<QList<QString>> &access_groups = ::OpenAPI::OptionalParam<QList<QString>>());

    /**
    * @param[in]  token QString [required]
    * @param[in]  tag QString [required]
    */
    void updateJobTag(const QString &token, const QString &tag);
