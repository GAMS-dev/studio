...
void OAIDefaultApi::updateConfiguration(const ::OpenAPI::OptionalParam<QString> &webhook_access, const ::OpenAPI::OptionalParam<qint32> &text_entries_max_size, const ::OpenAPI::OptionalParam<QString> &hostname) {
