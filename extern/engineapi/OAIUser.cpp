...
void OAIUser::fromJsonObject(QJsonObject json) {
    ...
    m_invitation_time_isValid = ::OpenAPI::fromJsonValue(invitation_time, json[QString("invitation_time")]);
...
QJsonObject OAIUser::asJsonObject() const {
    ...
    if (m_invitation_time_isSet) {
        obj.insert(QString("invitation_time"), ::OpenAPI::toJsonValue(invitation_time));
    }
...
void OAIUser::setInvitationTime(const QDateTime &invitation_time) {
    ...
    this->m_invitation_time_isSet = true;
}
