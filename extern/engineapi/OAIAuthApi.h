...
public:
    ...
    */
    void fetchOAuth2TokenOnBehalf(const QString &identity_provider_name, const ::OpenAPI::OptionalParam<QString> &grant_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &code = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &code_verifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &redirect_uri = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &device_code = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  x_fields QString [optional]
    */
    void listOIDCIdentityProviders(const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  expires_in qint32 [optional]
    */
    void loginWithOIDC(const QString &id_token, const ::OpenAPI::OptionalParam<QString> &scope = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &expires_in = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  device_authorization_endpoint QString [optional]
    */
    void updateOIDCIdentityProvider(const QString &name, const QString &label, const bool &hidden, const QString &web_ui_client_id, const QString &issuer, const QList<QString> &scopes, const ::OpenAPI::OptionalParam<QString> &web_ui_client_secret = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &device_client_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &device_client_secret = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &extra_client_ids = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<bool> &use_oidc_discover = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &authorization_endpoint = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &token_endpoint = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &jwks_uri = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &end_session_endpoint = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &device_authorization_endpoint = ::OpenAPI::OptionalParam<QString>());
