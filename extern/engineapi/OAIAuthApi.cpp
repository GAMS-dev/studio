...
void OAIAuthApi::fetchOAuth2TokenOnBehalf(const QString &identity_provider_name, const QString &code, const QString &code_verifier, const QString &redirect_uri) {
    ...
    {
        input.add_var("code_verifier", ::OpenAPI::toStringValue(code_verifier));
    }
