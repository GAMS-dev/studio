...
void OAIAuthApi::createOIDCIdentityProvider(const QString &name, const QString &label, const bool &hidden, const QString &web_ui_client_id, const QString &issuer, const QList<QString> &scopes, const ::OpenAPI::OptionalParam<QString> &web_ui_client_secret, const ::OpenAPI::OptionalParam<QString> &device_client_id, const ::OpenAPI::OptionalParam<QString> &device_client_secret, const ::OpenAPI::OptionalParam<QList<QString>> &extra_client_ids, const ::OpenAPI::OptionalParam<bool> &use_oidc_discover, const ::OpenAPI::OptionalParam<QString> &authorization_endpoint, const ::OpenAPI::OptionalParam<QString> &token_endpoint, const ::OpenAPI::OptionalParam<QString> &jwks_uri, const ::OpenAPI::OptionalParam<QString> &end_session_endpoint, const ::OpenAPI::OptionalParam<QString> &device_authorization_endpoint, const ::OpenAPI::OptionalParam<QList<QString>> &token_endpoint_auth_methods_supported, const ::OpenAPI::OptionalParam<QString> &uid) {
