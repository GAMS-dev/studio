...
#ifndef OAIIdentity_provider_oauth2_with_secret_H
#define OAIIdentity_provider_oauth2_with_secret_H
...
class OAIIdentity_provider_oauth2_with_secret : public OAIObject {
public:
    OAIIdentity_provider_oauth2_with_secret();
    OAIIdentity_provider_oauth2_with_secret(QString json);
    ~OAIIdentity_provider_oauth2_with_secret() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentity_provider_oauth2_with_secret)

#endif // OAIIdentity_provider_oauth2_with_secret_H
