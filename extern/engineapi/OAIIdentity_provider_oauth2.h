...
public:
    ...
    void setHasClientSecret(const bool &has_client_secret);
    bool is_has_client_secret_Set() const;
    bool is_has_client_secret_Valid() const;
...
private:
    ...
    bool m_has_client_secret_isSet;
    bool m_has_client_secret_isValid;
