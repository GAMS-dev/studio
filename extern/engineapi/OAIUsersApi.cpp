...
void OAIUsersApi::createInvitation(const ::OpenAPI::OptionalParam<QList<QString>> &roles, const ::OpenAPI::OptionalParam<QList<QString>> &namespace_permissions, const ::OpenAPI::OptionalParam<double> &parallel_quota, const ::OpenAPI::OptionalParam<double> &volume_quota, const ::OpenAPI::OptionalParam<qint32> &disk_quota, const ::OpenAPI::OptionalParam<QList<QString>> &labels, const ::OpenAPI::OptionalParam<QString> &default_label, const ::OpenAPI::OptionalParam<QList<QString>> &user_groups, const ::OpenAPI::OptionalParam<QString> &gams_license, const ::OpenAPI::OptionalParam<QString> &identity_provider_name, const ::OpenAPI::OptionalParam<QString> &identity_provider_user_subject, const ::OpenAPI::OptionalParam<QList<QString>> &invitable_identity_providers) {
...
void OAIUsersApi::createWebhook(const QString &url, const ::OpenAPI::OptionalParam<QString> &content_type, const ::OpenAPI::OptionalParam<QString> &secret, const ::OpenAPI::OptionalParam<bool> &recursive, const ::OpenAPI::OptionalParam<QList<QString>> &events, const ::OpenAPI::OptionalParam<bool> &insecure_ssl) {
...
void OAIUsersApi::listInvitations(const ::OpenAPI::OptionalParam<QString> &token, const ::OpenAPI::OptionalParam<bool> &everyone, const ::OpenAPI::OptionalParam<QString> &x_fields) {
...
void OAIUsersApi::listUsers(const ::OpenAPI::OptionalParam<QString> &username, const ::OpenAPI::OptionalParam<bool> &everyone, const ::OpenAPI::OptionalParam<QString> &x_fields) {
...
void OAIUsersApi::r_register(const QString &username, const QString &invitation_code, const ::OpenAPI::OptionalParam<QString> &password) {
