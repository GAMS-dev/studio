...
QString OAIIdentity_provider_oidc::getUid() const {
    return m_uid;
}
void OAIIdentity_provider_oidc::setUid(const QString &uid) {
    m_uid = uid;
    m_uid_isSet = true;
}

bool OAIIdentity_provider_oidc::is_uid_Set() const{
    return m_uid_isSet;
}

bool OAIIdentity_provider_oidc::is_uid_Valid() const{
